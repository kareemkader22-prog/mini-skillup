...
// ================= לוגיקת מסך חימוש ומקלדת וירטואלית =================
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // פתיחת המקלדת בלחיצה על תיבת הטקסט
    ...
    // דימוי ביצוע חיפוש ועדכון התוצאות
    if(searchSubmitBtn && searchResultsArea) {
        searchSubmitBtn.addEventListener("click", (e) => {
            ...
            if(query !== "") {
                searchResultsArea.innerHTML = `
                    <h4 style="margin: 0 0 12px 0; color: #1e293b; font-size: 16px; font-weight: 600;">Search Results for "${query}"</h4>
                    <div style="background: white; border-radius: 12px; padding: 16px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); margin-bottom: 12px; border: 2px solid #3b71f7;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                            <div>
                                <h5 style="margin: 0; font-size: 15px; color: #0f172a; font-weight: 600;">Junior Specialist - ${query}</h5>
                                <p style="margin: 4px 0 0 0; font-size: 13px; color: #64748b;">Global Tech Corp • Hybrid</p>
                            </div>
                            <span style="background: #e0f2fe; color: #0369a1; font-size: 11px; font-weight: 600; padding: 2px 8px; border-radius: 12px;">New Result</span>
                        </div>
                    </div>
                `;
            }
